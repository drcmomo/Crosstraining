(function () {
    ...
    function datacontext(common) {
        ...
        function logon(login, password, $scope) {
            ...
            $http({ method: 'GET', url: '/Logon/Logon?login=' + login + '&password=' + password }).success(function(response) {
                deferred.resolve(response);
                console.log("promise - prenom :  " + response.Prenom);
         ...
         //return  $http({ method: 'GET', url: '/Logon/Logon?login=' + login + '&password=' + password });
        }
